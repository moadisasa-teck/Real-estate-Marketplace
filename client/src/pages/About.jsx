...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      ...
      <p className='mb-6 text-lg text-slate-700 leading-relaxed'>
        We believe house finding isn’t just about buildings — it’s about people, dreams, and building futures. That’s why our mission is clear: deliver expert advice, exceptional service, and real results that leave a lasting impact.
      </p>
      <p className='text-lg text-slate-700 leading-relaxed'>
        Discover a better way to move forward — with <span className='font-semibold text-blue-600'>Integrated Estate</span>, where your house finding goals become reality.
      </p>
    </div>
  )
}
